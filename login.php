  ...
  <div class="container">
    ...
    <div class="cover">
      <div class="front">
        ...
        <div class="text">
          <span class="text-1">P.D.Xevier School<br></span>
        ...
        <div class="login-form">
          ...
          <form action="index.php" id="login-form" method="post">
            <div class="input-boxes">
              ...
              <input type="radio" name="remember" value="admin" required> admin
              <input type="radio" name="remember" value="owner" required> owner
              <input type="radio" name="remember" value="student" required> student
              <input type="radio" name="remember" value="teacher" required> teacher
              </div>
</br>
